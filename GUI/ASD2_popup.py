...
class Ui_Dialog(object):
    ...
    def setupUi(self, Dialog):
        ...
        if self.TDC_inst.asd_mezz.ASD2.channel_0_mode[0] == '00':
        ...
        if self.TDC_inst.asd_mezz.ASD2.channel_1_mode[0] == '00':
        ...
        if self.TDC_inst.asd_mezz.ASD2.channel_2_mode[0] == '00':
        ...
        if self.TDC_inst.asd_mezz.ASD2.channel_3_mode[0] == '00':
        ...
        if self.TDC_inst.asd_mezz.ASD2.channel_4_mode[0] == '00':
        ...
        if self.TDC_inst.asd_mezz.ASD2.channel_5_mode[0] == '00':
        ...
        if self.TDC_inst.asd_mezz.ASD2.channel_6_mode[0] == '00':
        ...
        if self.TDC_inst.asd_mezz.ASD2.channel_7_mode[0] == '00':
        ...
        self.comboBox.addItem("")
        if self.TDC_inst.asd_mezz.ASD2.chip_mode[0] == '0':
            self.comboBox.setCurrentIndex(0)
        if self.TDC_inst.asd_mezz.ASD2.chip_mode[0] == '1':
        ...
        self.spinbox_value = int(format(int(self.TDC_inst.asd_mezz.ASD2.main_thr[0], 2), '02d'))
        ...
        self.hyst_bin_rev = ''.join(reversed(str(self.TDC_inst.asd_mezz.ASD2.hyst[0])))
        ...
        self.wilkthr_index = format(int(self.TDC_inst.asd_mezz.ASD2.wilk_thr[0], 2), '02d')
        ...
        self.deadtime_index = format(int(self.TDC_inst.asd_mezz.ASD2.deadtime[0], 2), '02d')
        ...
        self.rundowncurr_index = format(int(self.TDC_inst.asd_mezz.ASD2.rundown_curr[0], 2), '02d')
        ...
        self.intgate_index = format(int(self.TDC_inst.asd_mezz.ASD2.int_gate[0], 2), '02d')
    ...
    def retranslateUi(self, Dialog):
        ...
        Dialog.setWindowTitle(_translate("Dialog", "ASD2"))
    ...
    def save_single(self):
        ...
        if self.checkBox.isChecked() == True:
            self.TDC_inst.asd_mezz.ASD2.channel_0_mode[0] = '00'
        else:
            self.TDC_inst.asd_mezz.ASD2.channel_0_mode[0] = '11'

        if self.checkBox_2.isChecked() == True:
            self.TDC_inst.asd_mezz.ASD2.channel_1_mode[0] = '00'
        else:
            self.TDC_inst.asd_mezz.ASD2.channel_1_mode[0] = '11'

        if self.checkBox_3.isChecked() == True:
            self.TDC_inst.asd_mezz.ASD2.channel_2_mode[0] = '00'
        else:
            self.TDC_inst.asd_mezz.ASD2.channel_2_mode[0] = '11'

        if self.checkBox_4.isChecked() == True:
            self.TDC_inst.asd_mezz.ASD2.channel_3_mode[0] = '00'
        else:
            self.TDC_inst.asd_mezz.ASD2.channel_3_mode[0] = '11'

        if self.checkBox_5.isChecked() == True:
            self.TDC_inst.asd_mezz.ASD2.channel_4_mode[0] = '00'
        else:
            self.TDC_inst.asd_mezz.ASD2.channel_4_mode[0] = '11'

        if self.checkBox_6.isChecked() == True:
            self.TDC_inst.asd_mezz.ASD2.channel_5_mode[0] = '00'
        else:
            self.TDC_inst.asd_mezz.ASD2.channel_5_mode[0] = '11'

        if self.checkBox_7.isChecked() == True:
            self.TDC_inst.asd_mezz.ASD2.channel_6_mode[0] = '00'
        else:
            self.TDC_inst.asd_mezz.ASD2.channel_6_mode[0] = '11'

        if self.checkBox_8.isChecked() == True:
            self.TDC_inst.asd_mezz.ASD2.channel_7_mode[0] = '00'
        else:
            self.TDC_inst.asd_mezz.ASD2.channel_7_mode[0] = '11'


        #chip_mode
        if self.comboBox.currentIndex() == 0:
            self.TDC_inst.asd_mezz.ASD2.chip_mode[0] = '0'
        else:
            self.TDC_inst.asd_mezz.ASD2.chip_mode[0] = '1'
