...
def generateXML(fileName):
	...
	TDC_ID = ET.SubElement(mode_set, 'TDC_ID')
	TDC_ID.text = '1111010101010101010'
	width_select = ET.SubElement(mode_set, 'width_select')
	width_select.text = '000'
	...
	channel_enable_r = ET.SubElement(mode_set, 'channel_enable_r')
	channel_0 = ET.SubElement(channel_enable_r, 'channel_0')
	channel_0.text = '1'
	channel_1 = ET.SubElement(channel_enable_r, 'channel_1')
	channel_1.text = '1'
	channel_2 = ET.SubElement(channel_enable_r, 'channel_2')
	channel_2.text = '1'
	channel_3 = ET.SubElement(channel_enable_r, 'channel_3')
	channel_3.text = '1'
	channel_4 = ET.SubElement(channel_enable_r, 'channel_4')
	channel_4.text = '1'
	channel_5 = ET.SubElement(channel_enable_r, 'channel_5')
	channel_5.text = '1'
	channel_6 = ET.SubElement(channel_enable_r, 'channel_6')
	channel_6.text = '1'
	channel_7 = ET.SubElement(channel_enable_r, 'channel_7')
	channel_7.text = '1'
	channel_8 = ET.SubElement(channel_enable_r, 'channel_8')
	channel_8.text = '1'
	channel_9 = ET.SubElement(channel_enable_r, 'channel_9')
	channel_9.text = '1'
	channel_10 = ET.SubElement(channel_enable_r, 'channel_10')
	channel_10.text = '1'
	channel_11 = ET.SubElement(channel_enable_r, 'channel_11')
	channel_11.text = '1'
	channel_12 = ET.SubElement(channel_enable_r, 'channel_12')
	channel_12.text = '1'
	channel_13 = ET.SubElement(channel_enable_r, 'channel_13')
	channel_13.text = '1'
	channel_14 = ET.SubElement(channel_enable_r, 'channel_14')
	channel_14.text = '1'
	channel_15 = ET.SubElement(channel_enable_r, 'channel_15')
	channel_15.text = '1'
	channel_16 = ET.SubElement(channel_enable_r, 'channel_16')
	channel_16.text = '1'
	channel_17 = ET.SubElement(channel_enable_r, 'channel_17')
	channel_17.text = '1'
	channel_18 = ET.SubElement(channel_enable_r, 'channel_18')
	channel_18.text = '1'
	channel_19 = ET.SubElement(channel_enable_r, 'channel_19')
	channel_19.text = '1'
	channel_20 = ET.SubElement(channel_enable_r, 'channel_20')
	channel_20.text = '1'
	channel_21 = ET.SubElement(channel_enable_r, 'channel_21')
	channel_21.text = '1'
	channel_22 = ET.SubElement(channel_enable_r, 'channel_22')
	channel_22.text = '1'
	channel_23 = ET.SubElement(channel_enable_r, 'channel_23')
	channel_23.text = '1'

	channel_enable_f = ET.SubElement(mode_set, 'channel_enable_f')
	channel_0 = ET.SubElement(channel_enable_f, 'channel_0')
	channel_0.text = '1'
	channel_1 = ET.SubElement(channel_enable_f, 'channel_1')
	channel_1.text = '1'
	channel_2 = ET.SubElement(channel_enable_f, 'channel_2')
	channel_2.text = '1'
	channel_3 = ET.SubElement(channel_enable_f, 'channel_3')
	channel_3.text = '1'
	channel_4 = ET.SubElement(channel_enable_f, 'channel_4')
	channel_4.text = '1'
	channel_5 = ET.SubElement(channel_enable_f, 'channel_5')
	channel_5.text = '1'
	channel_6 = ET.SubElement(channel_enable_f, 'channel_6')
	channel_6.text = '1'
	channel_7 = ET.SubElement(channel_enable_f, 'channel_7')
	channel_7.text = '1'
	channel_8 = ET.SubElement(channel_enable_f, 'channel_8')
	channel_8.text = '1'
	channel_9 = ET.SubElement(channel_enable_f, 'channel_9')
	channel_9.text = '1'
	channel_10 = ET.SubElement(channel_enable_f, 'channel_10')
	channel_10.text = '1'
	channel_11 = ET.SubElement(channel_enable_f, 'channel_11')
	channel_11.text = '1'
	channel_12 = ET.SubElement(channel_enable_f, 'channel_12')
	channel_12.text = '1'
	channel_13 = ET.SubElement(channel_enable_f, 'channel_13')
	channel_13.text = '1'
	channel_14 = ET.SubElement(channel_enable_f, 'channel_14')
	channel_14.text = '1'
	channel_15 = ET.SubElement(channel_enable_f, 'channel_15')
	channel_15.text = '1'
	channel_16 = ET.SubElement(channel_enable_f, 'channel_16')
	channel_16.text = '1'
	channel_17 = ET.SubElement(channel_enable_f, 'channel_17')
	channel_17.text = '1'
	channel_18 = ET.SubElement(channel_enable_f, 'channel_18')
	channel_18.text = '1'
	channel_19 = ET.SubElement(channel_enable_f, 'channel_19')
	channel_19.text = '1'
	channel_20 = ET.SubElement(channel_enable_f, 'channel_20')
	channel_20.text = '1'
	channel_21 = ET.SubElement(channel_enable_f, 'channel_21')
	channel_21.text = '1'
	channel_22 = ET.SubElement(channel_enable_f, 'channel_22')
	channel_22.text = '1'
	channel_23 = ET.SubElement(channel_enable_f, 'channel_23')
	channel_23.text = '1'
