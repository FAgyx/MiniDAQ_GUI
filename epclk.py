...
class Ui_Dialog(object):
    ...
    def setupUi(self, Dialog):
        ...
        for i in range(self.clocks):
            ...
            self.freq_list.append(freq_box)
            ...
            self.ds_list.append(drive_strength)
...
###################################################################################################################
    ...
    def return_byte(self):
        print(self.checkBox)
        for inv in self.checkbox_list:
            if self.checkBox == inv:
                print(inv)



    ## Maybe use this function for when want to save all of them!
    # def return_byte(self):
    #     val = 0
    #     for invert, datarate, freq in zip(self.checkbox_list, self.ds_list, self.freq_list):
    #         if invert.isChecked():
    #             inv_state = 1
    #         else:
    #             inv_state = 0
    #         value_list = [inv_state, datarate.currentIndex(), freq.currentIndex()]
    #         print(value_list)
    #         self.address = 108 + val
    #         print(self.address)
    #         val += 2
